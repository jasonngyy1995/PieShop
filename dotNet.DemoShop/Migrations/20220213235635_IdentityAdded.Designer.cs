...
namespace dotNet.DemoShop.Migrations
{
    ...
    [Migration("20220213235635_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.OrderDetail", b =>
                {
                    b.HasOne("dotNet.DemoShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotNet.DemoShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dotNet.DemoShop.Models.Pie", b =>
                {
                    b.HasOne("dotNet.DemoShop.Models.Category", "Category")
                        .WithMany("Pies")
